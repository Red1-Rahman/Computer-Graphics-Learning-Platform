...
with tab_2d:
    ...
    # ══════════════════════════════════════════════════════════════════════════
    with subtab_trans2d:
        section_header("2D Translation", "tba", "https://youtu.be/EUQoWgzLOHc?si=4J1shTDJB_KtLR_z")
...
with tab_3d:
    ...
    # ══════════════════════════════════════════════════════════════════════════
    with subtab_rot3d:
        section_header("3D Rotation", "tba", "https://youtu.be/xogen7EICDU?si=GMyxw5kCxo3x1aG0&t=140")
    ...
    # ══════════════════════════════════════════════════════════════════════════
    with subtab_trans3d:
        section_header("3D Translation", "tba", "https://youtu.be/xogen7EICDU?si=GMyxw5kCxo3x1aG0")
